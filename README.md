...
| [aws_iam_policy.migrator_secrets_policy](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_policy) | resource |
...
| [aws_iam_role_policy_attachment.migrator_secrets_policy](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_role_policy_attachment) | resource |
...
| [aws_iam_policy_document.migrator_secrets_policy](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/iam_policy_document) | data source |
...
| <a name="input_permissions_boundary_arn"></a> [permissions\_boundary\_arn](#input\_permissions\_boundary\_arn) | ARN for the IAM permissions boundary to attach to the task execution role | `string` | `null` | no |
...
| <a name="input_repository_credentials_arn"></a> [repository\_credentials\_arn](#input\_repository\_credentials\_arn) | ARN of Secrets Manager secret containing private registry credentials. | `string` | `null` | no |
